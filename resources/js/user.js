$(document).ready(function() {
    ...
    $(document, this).on('click', '.save_button', function(e){
        e.preventDefault();
        let url = $("#typeProcess").val() == '1' ? ADD_USER_URL : UPDATE_USER_URL;
    ...
    function getUserList(keywordText = ''){
        $.ajax({
            url: SEARCH_USER_URL,
            method: 'GET',
            dataType: 'json',
            ...
            success: function(response){
                let userSearchBody = $("#user_search_body");
                userSearchBody.empty();
                let html = '';
                    ...
                    html += `<tr class="bg-white hover:bg-gray-200">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <button type="button"
                                        ...
                                        <button type="button"
                                            class="bg-red-500 px-2 py-1 rounded-lg text-white hover:bg-white hover:text-black delete-button ${value.id == USER_ID ? 'hidden' : ''}"
                                            data-id="${value.id}">
